...
class RootViewController: UITabBarController {
    ...
    func creatSubViewController() {
        ...
        findNav.tabBarItem = UITabBarItem.init(title: "发现", image: #imageLiteral(resourceName: "TAB_FIND-IMAGE"), selectedImage: #imageLiteral(resourceName: "TAB_FIND-SELECTEDIMAGE").withRenderingMode(.alwaysOriginal))
